# package.ps1 — Generated by Azure Machine Configuration Builder
...
$mofPath = Join-Path $PSScriptRoot 'WinRegistryAuditManual.mof'
...
Write-Host "[BUILD] Creating MC package (Type: Audit)..." -ForegroundColor Cyan

$package = New-GuestConfigurationPackage `
    -Name 'WinRegistryAuditManual' `
...
Write-Host "   1. Upload output\WinRegistryAuditManual.zip to Azure Blob Storage"
...
Write-Host "      New-AzPolicyDefinition -Name 'WinRegistryAuditManual' -Policy '.\policy.json' -Mode 'Indexed'"
