...
export const templates: TemplateInfo[] = [
  {
    ...
    description: 'CIS-aligned registry checks: TLS hardening, Defender, Firewall, WDigest, audit logging (14 resources)',
    platform: 'Windows',
  ...
  },
  {
    ...
    description: 'CIS-aligned audit policy: logon, account management, policy changes, system events (8 resources)',
    platform: 'Windows',
  ...
  },
  {
    ...
    description: 'Firewall rules: allow HTTPS, block RDP/SMB/WinRM on public, ensure firewall service (5 resources)',
    platform: 'Windows',
  ...
  },
  {
    ...
    description: 'Custom compliance checks using nxScript — firewall, world-writable files, NTP, empty passwords (5 resources)',
    platform: 'Linux',
  ...
  },
  {
    ...
    description: 'Root group, /etc/passwd + /etc/shadow permissions, login.defs password policy, UID 0 audit (6 resources)',
    platform: 'Linux',
  ...
  },
  {
    ...
    description: 'Audit AND fix kernel sysctl parameters — IP forwarding, SYN cookies, ICMP redirects, reverse path filtering, core dumps (5 resources, AuditAndSet)',
    platform: 'Linux',
