...
export const nxFileSchema: ResourceSchema = {
  ...
  properties: [
    ...
    { name: 'Mode', description: 'Permissions in octal (e.g., 0644). Required when AuditAndSet may create this item.', type: 'string', required: false, isKey: false, placeholder: '0644' },
    ...
    { name: 'Owner', description: 'File owner. Required when AuditAndSet may create this item; choose explicitly.', type: 'string', required: false, isKey: false, placeholder: 'root' },
    { name: 'Group', description: 'File group. Required when AuditAndSet may create this item; choose explicitly.', type: 'string', required: false, isKey: false, placeholder: 'root' },
  ],
};
